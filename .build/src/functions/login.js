...
var handler = function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, USER_POOL_ID, USER_POOL_CLIENT_ID, error, request, login, password, result, e_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                if (!event.body) {
                    return [2 /*return*/, (0, formatResponseUtil_1.formatDefaultResponse)(400, 'Parâmetros de entrada inválidos')];
                }
                ...
                return [4 /*yield*/, new CognitoServices_1.CognitoServices(USER_POOL_ID, USER_POOL_CLIENT_ID).login(login, password)];
            case 1:
                result = _b.sent();
                return [2 /*return*/, (0, formatResponseUtil_1.formatDefaultResponse)(200, undefined, result)];
            case 2:
                e_1 = _b.sent();
